...
class TicketControllerTest {
    ...
    public void whenFoundFilmSessionByIdThenGetTicketsBuy() {
        var filmSession = new FilmSessionDto(1, "film", "hall", now(),
                now().plusHours(2), "300");
    ...
    public void whenRequestBuyTicketThenGetSuccessfulBuyPage() {
        var ticket = new Ticket(1, 1, 5, 10, 1);
        ...
        assertThat(actualMessage).isEqualTo("Вы забронировали билет на 5 ряд 10 место");
    }
